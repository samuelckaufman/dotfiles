...
$fatpacked{"x86_64-linux-gnu-thread-multi/List/Util.pm"} = <<'X86_64-LINUX-GNU-THREAD-MULTI_LIST_UTIL';
  # List::Util.pm
  #
...
$fatpacked{"x86_64-linux-gnu-thread-multi/List/Util/XS.pm"} = <<'X86_64-LINUX-GNU-THREAD-MULTI_LIST_UTIL_XS';
...
$fatpacked{"x86_64-linux-gnu-thread-multi/Scalar/Util.pm"} = <<'X86_64-LINUX-GNU-THREAD-MULTI_SCALAR_UTIL';
  # Scalar::Util.pm
  #
  # Copyright (c) 1997-2007 Graham Barr <gbarr@pobox.com>. All rights reserved.
  # This program is free software; you can redistribute it and/or
